...
- Autenticação, autorização, JWT e Spring Security
- Docker, Docker Compose e configuração por variáveis de ambiente
- Validações, regras de negócio, tratamento de erros e documentação de APIs
...
![Spring Security](https://img.shields.io/badge/Spring_Security-191724?style=for-the-badge&logo=springsecurity&logoColor=white)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL-4e676c?style=for-the-badge&logo=postgresql&logoColor=white)
...
| --- | --- | --- |
| [Auth User API](https://github.com/ViiniDev/auth-user-api) | API REST de autenticação com cadastro, login, JWT, BCrypt, roles `USER` e `ADMIN`, endpoint protegido e ambiente com PostgreSQL via Docker Compose. | Java, Spring Boot, Spring Security, JWT, JPA, PostgreSQL, Docker |
| [Personal Finance API](https://github.com/ViiniDev/personal-finance-api) | API REST para controle financeiro pessoal, com categorias, transações, filtros por período, resumo mensal e execução com Docker Compose. | Java, Spring Boot, JPA, H2, PostgreSQL, Swagger, Docker |
| [Helpdesk API Java](https://github.com/ViiniDev/helpdesk-api-java) | API REST para chamados de suporte, com fluxo de status, atribuição de técnico, comentários e bloqueio de alterações em chamados fechados. | Java, Spring Boot, JPA, Bean Validation, H2, PostgreSQL, Docker |
| [Library Loans API](https://github.com/ViiniDev/library-loans-api) | API REST para biblioteca, com livros, leitores, empréstimos, devolução e regra para impedir empréstimo de livro indisponível. | Java, Spring Boot, JPA, H2, PostgreSQL, Swagger, Docker |
...
Tenho organizado meus projetos com READMEs completos, instruções de execução, Swagger, Docker Compose, separação de responsabilidades e commits claros. Meu objetivo é demonstrar evolução consistente, capacidade de aprender rápido e cuidado com código que outras pessoas consigam entender, executar e manter.

## Contato

[![Portfólio](https://img.shields.io/badge/Portfólio-191724?style=for-the-badge&logo=vercel&logoColor=white)](https://viinidev.com)
